...
export const MODELS = {
	...
	"ppq": {
		...
		"private/deepseek-r1-0528": {
			...
			name: "DeepSeek R1 (Private via TEE)",
			api: "openai-completions",
			provider: "ppq",
			baseUrl: "https://api.ppq.ai",
			reasoning: false,
		...
		"private/gpt-oss-120b": {
			...
			name: "GPT-OSS 120B (Private via TEE)",
			api: "openai-completions",
			provider: "ppq",
			baseUrl: "https://api.ppq.ai",
			reasoning: false,
		...
		"private/kimi-k2-5": {
			...
			name: "Kimi K2.5 (Private via TEE)",
			api: "openai-completions",
			provider: "ppq",
			baseUrl: "https://api.ppq.ai",
			reasoning: false,
		...
		"private/llama3-3-70b": {
			...
			name: "Llama 3.3 70B (Private via TEE)",
			api: "openai-completions",
			provider: "ppq",
			baseUrl: "https://api.ppq.ai",
			reasoning: false,
		...
		"private/qwen3-vl-30b": {
			...
			name: "Qwen3-VL 30B (Private via TEE)",
			api: "openai-completions",
			provider: "ppq",
			baseUrl: "https://api.ppq.ai",
			reasoning: false,
