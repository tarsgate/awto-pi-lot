...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@knocte/pi-tui";
...
const THEME_KEY = Symbol.for("awto-pi-lot:theme");
...
export function getSettingsListTheme(): import("@knocte/pi-tui").SettingsListTheme {
	return {
