...
import { Agent, type AgentMessage, type ThinkingLevel } from "@knocte/pi-agent-core";
import type { Message, Model } from "@knocte/pi-ai";
 ...
 *
 * // With explicit model
 * import { getModel } from '@knocte/pi-ai';
 * const { session } = await createAgentSession({
